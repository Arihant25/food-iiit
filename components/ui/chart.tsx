    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          "[&_.recharts-text]:text-[10px] md:[&_.recharts-text]:text-xs [&_.recharts-xAxis_.recharts-cartesian-axis-tick-value]:text-[9px] md:[&_.recharts-xAxis_.recharts-cartesian-axis-tick-value]:text-xs",
...
// Re-export recharts components with our custom components
const ChartTitle = ({ children, className }: React.ComponentProps<"h3">) => (
  <h3 className={cn("text-sm font-medium text-muted-foreground", className)}>
    {children}
  </h3>
)

// Re-export the necessary components from recharts
const {
  Bar,
  BarChart,
  CartesianGrid,
